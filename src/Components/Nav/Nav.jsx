...
=======
import search from "./../../assets/icons/search.svg";
>>>>>>> e70cc4c610d8226aeab500727d8eb854daa6fe34
...
<<<<<<< HEAD
      ...
      <div className="relative">
        ...
        <input className="border-black border-2 w-[300px] rounded-3xl pl-5 py-[3px] max-md:hidden" type="text" placeholder="Search" />
=======
        <li>
